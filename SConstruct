...
lib = IEBuild.SharedLibrary(
	...
	includePath = [
		"include",
		"/software/tools/include/eigen/3.2.0/cent6.x86_64/include/Eigen",
		"/software/tools/include/cent6.x86_64/tbb/4.1/"
	]
)
lib.setCompiler( plugin.getCompiler(), plugin.getCompilerVersion() )
lib.addLib("GL")
lib.addLib( "tbb" )
...
prog.setCompiler( plugin.getCompiler(), plugin.getCompilerVersion() )
prog.addLib("MpmSim")
prog.addLib("glut")
prog.addLib("GL")
prog.addLib("GLU")
