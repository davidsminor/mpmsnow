...
public:
	...
	virtual void createParticleData( MaterialPointDataMap& p ) const = 0;
	...
	virtual void updateParticleData( MaterialPointDataMap& p ) const = 0;
	
	// set up particles: must be called before using the following 3 methods
	virtual void setParticles( MaterialPointDataMap& p ) const = 0;
	...
	static std::vector<float>& scalarData( MaterialPointDataMap& p, const std::string& name );
	static std::vector<Eigen::Vector3f>& vectorData( MaterialPointDataMap& p, const std::string& name );
	static std::vector<Eigen::Matrix3f>& matrixData( MaterialPointDataMap& p, const std::string& name );
